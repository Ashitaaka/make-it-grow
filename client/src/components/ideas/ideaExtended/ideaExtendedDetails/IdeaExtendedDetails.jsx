      ...
      <div className={`details ${expandedSections.details ? 'active' : ''}`}>
        <div className="header">
          <div className="title">
            <div
              style={{
                backgroundColor: expandedSections.details
                  ? `var(${idea.color})`
                  : 'transparent',
                border: expandedSections.details
                  ? 'none'
                  : `2px solid var(${idea.color})`,
              }}
          ...
          <div className="content-container">
            ...
            <div className="p-content">
              <p>
                ...
                Phasellus rutrum libero justo, vitae pulvinar ipsum condimentum
                blandit. Nam convallis sollicitudin libero in scelerisque. Sed
                maximus eros in lectus sollicitudin, ac hendrerit mi cursus.
                Nulla consequat eu nibh at faucibus. Nam volutpat non ipsum
                vestibulum condimentum. Mauris convallis risus purus, eget
                feugiat enim ullamcorper et. Etiam at ultrices urna, ac pharetra
                ipsum. Maecenas eget justo purus. Pellentesque pretium ante non
                dolor venenatis congue. Fusce maximus fringilla consequat. Orci
      ...
      <div className={`impact ${expandedSections.impact ? 'active' : ''}`}>
        <div className="header">
          <div className="title">
            <div
              style={{
                backgroundColor: expandedSections.impact
                  ? `var(${idea.color})`
                  : 'transparent',
                border: expandedSections.impact
                  ? 'none'
                  : `2px solid var(${idea.color})`,
              }}
              className="categorie"></div>
      ...
      <div className={`benefits ${expandedSections.benefits ? 'active' : ''}`}>
        <div className="header">
          <div className="title">
            <div
              style={{
                backgroundColor: expandedSections.benefits
                  ? `var(${idea.color})`
                  : 'transparent',
                border: expandedSections.benefits
                  ? 'none'
                  : `2px solid var(${idea.color})`,
              }}
              className="categorie"></div>
      ...
      <div className={`risks ${expandedSections.risks ? 'active' : ''}`}>
        <div className="header">
          <div className="title">
            <div
              style={{
                backgroundColor: expandedSections.risks
                  ? `var(${idea.color})`
                  : 'transparent',
                border: expandedSections.risks
                  ? 'none'
                  : `2px solid var(${idea.color})`,
              }}
              className="categorie"></div>
      ...
      <div className={`comments ${expandedSections.comments ? 'active' : ''}`}>
        <div className="header">
          <div className="title">
            <div
              style={{
                backgroundColor: expandedSections.comments
                  ? `var(${idea.color})`
                  : 'transparent',
                border: expandedSections.comments
                  ? 'none'
                  : `2px solid var(${idea.color})`,
              }}
              className="categorie"></div>
